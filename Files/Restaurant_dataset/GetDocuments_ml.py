...
tree = ET.parse('restaurant-trial.xml')
...
#File
dataset_Test_spanish_doc = open('S3_EN_RESTAURANT_TEST_ABAA.reviews.gold','w',encoding='utf-8') 
dataset_Test_spanish_aspect = open('S3_EN_RESTAURANT_TEST_ABAA.aspects.gold','w',encoding='utf-8') 
dataset_Test_spanish_polarities = open('S3_EN_RESTAURANT_TEST_ABAA.polarities.gold','w',encoding='utf-8')
